...
public class HttpTaskServerTest {
    ...
    public void testAddTask() {
        Task task = new Task("Task title", "Task description", TaskStatus.NEW, "30.01.23 12.15", 30);
    ...
    public void testAddSubtask() {
        Subtask task = new Subtask("Task title", "Task description", TaskStatus.NEW, "30.01.23 12.15", 30, 3);
        String taskJson = gson.toJson(task);
